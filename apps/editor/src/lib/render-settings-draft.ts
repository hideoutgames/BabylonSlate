...
export type RenderingDraft = Pick<
  ProjectSettings,
  "render" | "playFrameCap" | "playPreview"
>;
export function renderingDraft(settings: ProjectSettings): RenderingDraft {
  return structuredClone({
    render: settings.render,
    playFrameCap: settings.playFrameCap,
    playPreview: settings.playPreview,
  });
}
/** Only edited leaves replace the latest project values. Reverted edits disappear. */
export function mergeRenderingDraft(
  base: RenderingDraft,
  draft: RenderingDraft,
