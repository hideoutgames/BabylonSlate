...
- **Navigation** becomes pan and zoom only: one finger to marquee-select, three fingers to pan, pinch to zoom, no look/orbit. Orbiting an orthographic 2D scene is how you get lost.
