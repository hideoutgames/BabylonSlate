...
- *Prefab* (Actor): **full-size center-group tab**, sibling of Graph (`direction: "within"`). Same touch gizmos / two-finger camera as the Scene viewport. Not a fourth chrome `DocumentKind`. Persistence is preview-only.
