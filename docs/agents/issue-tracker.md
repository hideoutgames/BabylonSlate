...
| 2026-09-21 | zeron/babylonslate-rendering-handoff | September 2026 rendering handoff | Spec | A16 testing is deferred by user and remains unmeasured. Production outlines, renderer scalability transactions/nodes and rectangular area-light integration remain open; browser acceptance is required. | Open |
