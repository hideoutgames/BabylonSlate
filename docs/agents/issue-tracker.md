...
| 2026-08-11 | cursor/p3-spawn-guard-e177 | p3-object-model | Standards | Double `spawnActorNow` could duplicate the same actor; reject re-spawn before P4 scene loader | Resolved |
