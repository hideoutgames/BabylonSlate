...
- The node palette is an anchored popup clamped inside the safe-area viewport (search **not** autofocused on touch); the toolbar **+** opens it just under the button. Long-press / secondary click opens node context menus when enabled.
