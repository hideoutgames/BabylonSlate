...
| CSS | `overscroll-behavior: contain` on intentional scroll regions | Content browser, chrome closable-tab scroller, homepage body and Start gallery |
...
- Homepage Start gallery — wrapping template cards (`overflow-y-auto overflow-x-auto overscroll-contain`, height-capped)
