...
The targeted engine-command case, scoped static checks, and the four WebGL2/WebGPU CPU/GPU browser cases remain unexecuted at this checkpoint. Physical A16 measurements are not included; they were waived for this delivery. No device timing or GPU output result is inferred from NullEngine tests.
