...
| Designer (Dockview Design / Hierarchy / Details / Logic; EUI Settings), Font / Sprite editors, graph hosts, Play HUD host | `apps/editor` | `@babylonslate/ui`, `editor-kit`, `graph-ui` |
