...
- Bulk apply / despawn wrapped in `blockMaterialDirtyMechanism` and `blockfreeActiveMeshesAndRenderingGroups` — both restored to the values captured at entry, not unconditionally cleared.
