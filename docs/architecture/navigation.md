...
- 3D collect: `MeshComponent` world meshes + static unwalkable blockers. Dynamic / cost blockers are skipped at bake. When Bake Bounds is on, meshes whose world AABB misses the box are dropped.
