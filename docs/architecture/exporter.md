...
5. Recurse to a fixed point. Drop EditorUtilityObject / leftover EditorUtilityInterface / PluginSettings / SkyboxCreator (`isEditorOnlyAsset`). Generated skybox face Textures stay in the pack when a scene `SkyboxComponent` references them. Unused UserInterface assets stay out of the pack.
