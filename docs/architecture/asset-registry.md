...
- `AlertDialog variant="destructive"` lists removed asset names and inbound refs from `showReferences` (names are `SelectableText`). Toolbar Delete only opens this dialog; confirming is the destructive step.
