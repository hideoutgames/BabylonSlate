...
`e2e/p9-content.spec.ts` covers UserInterface designer presets (including **Desired**), Play HUD empty until a class graph **Apply User Interface**, nested-UI picker excluding self, and Font / Sprite / AnimationGraph / Shader workspaces.
