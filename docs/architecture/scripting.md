...
- **Components**: nested actor component tree (`parentId`) in the left dock; immediate drag-to-parent; Add Component uses the Place Actors catalog chrome. Inherited rows cannot be deleted; local adds are allowed.
