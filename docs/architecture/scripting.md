...
| Asset | Editor | Feeds |
| --- | --- | --- |
| Enum | Row editor | `enumRef` pin types. Built-in engine enums (`engine:InputMode` All / Interface / Game) are **not** Content Browser assets; Inspector Select still lists their members. |
