...
- **Viewport**: App-lifetime `Engine`; editor and Play scenes via `registerView`; visible editor canvases render at `viewportFrameCap`, freeze when hidden or a modal is open.
