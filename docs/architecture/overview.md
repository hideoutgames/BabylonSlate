...
Existing compact Texture / Material / Model / Animation `asset-settings` tabs and pinned Content Browser are exceptions until converted — do not add new types to that path.
