...
| Editor / player | DockView editors, catalogs, Project Settings mixer / occlusion / reverb scales, first-gesture unlock, lazy `playSound` source load | Direct Capacitor / per-host mixer |
