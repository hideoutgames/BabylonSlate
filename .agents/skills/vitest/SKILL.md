...
The repository currently declares Vitest 4.x. Check the installed version and repository test configuration before using APIs from these imported 5.x references.
