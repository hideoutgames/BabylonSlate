...
const ENGINE_PARENT: Record<string, string | null> = {
  ...
  StackPanelWidget: "Widget",
  HorizontalBoxWidget: "Widget",
  VerticalBoxWidget: "Widget",
  GridWidget: "Widget",
  ScrollViewerWidget: "Widget",
  ScrollBoxWidget: "Widget",
  EllipseWidget: "Widget",
  ContainerWidget: "Widget",
  OverlayWidget: "Widget",
  SizeBoxWidget: "Widget",
  BorderWidget: "Widget",
  ButtonWidget: "Widget",
  ...
  TouchButtonWidget: "Widget",
  TouchDPadWidget: "Widget",
  UserInterfaceWidget: "Widget",
};
