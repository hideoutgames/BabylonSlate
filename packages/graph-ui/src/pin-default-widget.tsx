...
const FIELD_CLASS =
  "pointer-events-none h-8 max-w-[var(--graph-pin-default-max-width,8rem)] shrink-0 truncate rounded-sm border border-input bg-input/30 px-1.5 text-base leading-8 text-foreground select-none";
