...
export function materialGlslDiagnostic(message: string, operations: readonly MaterialOperation[], effect?: Pick<Effect, "vertexSourceCode" | "fragmentSourceCode"> | null): MaterialDiagnostic {
