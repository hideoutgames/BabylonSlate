...
PRs stay draft until local `pnpm verify` passes; mark ready once; at most 3 non-draft PRs at a time. Details in [.cursor/rules/github-actions-pr-cadence.mdc](.cursor/rules/github-actions-pr-cadence.mdc).
